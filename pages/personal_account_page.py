...
class UserProfilePage(BasePage):
    ...
    def click_order_history_button(self):
        ...
        return self.find_element_with_wait(PersonalAccountLocators.ENABLED_ORDER_HISTORY_BUTTON)
    ...
    def get_all_order_numbers_from_history(self):
        order_numbers = self.find_elements_with_wait(PersonalAccountLocators.ORDER_NUMBERS_IN_ORDER_HISTORY)
